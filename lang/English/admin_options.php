...
'Version number help'				=>	'Show ReFlux version number in footer.',
...
'Clickable links help'				=>	'When enabled, ReFlux will automatically detect any URLs in posts and make them clickable hyperlinks.',
...
'Quick post help'					=>	'When enabled, ReFlux will add a quick reply form at the bottom of topics. This way users can post directly from the topic view.',
...
'Upload directory help'				=>	'The upload directory for avatars (relative to the ReFlux root directory). PHP must have write permissions to this directory.',
...
'Report new help'					=>	'If enabled, ReFlux will notify users on the mailing list (see above) when a new user registers in the forums.',
