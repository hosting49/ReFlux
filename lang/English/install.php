...
'Already installed'				=>	'It seems like ReFlux is already installed. You should go <a href="index.php">here</a> instead.',
'You are running error'			=>	'You are running %1$s version %2$s. ReFlux %3$s requires at least %1$s %4$s to run properly. You must upgrade your %1$s installation before you can continue.',
'My ReFlux Forum'				=>	'My ReFlux Forum',
'Description'					=>	'Unfortunately no one can be told what ReFlux is - you have to see it for yourself.',
...
'No DB extensions'				=>	'This PHP environment does not have support for any of the databases that ReFlux supports. PHP needs to have support for either MySQL, PostgreSQL or SQLite in order for ReFlux to be installed.',
'Administrator username'		=>	'Administrator\'s username',
'Administrator email'			=>	'Administrator\'s email',
'Board title'					=>	'Board title',
'Base URL'						=>	'The URL (without trailing slash) of your ReFlux forum. This must be correct.',
'Required field'				=>	'is a required field in this form.',
'ReFlux Installation'			=>	'ReFlux Installation',
'Welcome'						=>	'You are about to install ReFlux. In order to install ReFlux, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Install'						=>	'Install ReFlux %s',
...
'Info 4'						=>	'The name of the database you want to install ReFlux on.',
...
'Info 6'						=>	'If you want to run multiple ReFlux installations in a single database, change this.',
...
'Existing table error'			=>	'A table called \'%susers\' is already present in the database \'%s\'. This could mean that ReFlux is already installed or that another piece of software is installed and is occupying one or more of the table names ReFlux requires. If you want to install multiple copies of ReFlux in the same database, you must choose a different table prefix',
...
'Message'						=>	'If you are looking at this (which I guess you are), the install of ReFlux appears to have worked! Now log in and head over to the administration control panel to configure your forum.',
'Test category'					=>	'Test category',
'Test forum'					=>	'Test forum',
'This is just a test forum'		=>	'This is just a test forum',
'Alert cache'					=>	'<strong>The cache directory is currently not writable!</strong> In order for ReFlux to function properly, the directory <em>%s</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
...
'ReFlux has been installed'		=>	'ReFlux has been installed. To finalize the installation please follow the instructions below.',
'Final instructions'			=>	'Final instructions',
'Info 17'						=>	'To finalize the installation, you need to click on the button below to download a file called config.php. You then need to upload this file to the root directory of your ReFlux installation.',
'Info 18'						=>	'Once you have uploaded config.php, ReFlux will be fully installed! At that point, you may <a href="index.php">go to the forum index</a>.',
'Download config.php file'		=>	'Download config.php file',
'ReFlux fully installed'		=>	'ReFlux has been fully installed! You may now <a href="index.php">go to the forum index</a>.',
